  ...
  item =  <<ITEM
          {
            ...
            "ingredients": {"L": [
              ...
              {"M": { "name":{"S":"Mayonnaise"}, "unit":{"S":"Cup"}, "amount":{"N":"1/2"} } },
              {"M": { "name":{"S":"Dried Dill Weed"}, "unit":{"S":"tsp."}, "amount":{"N":"1"} } },
              {"M": { "name":{"S":"Dried Parsely"}, "unit":{"S":"tsp."}, "amount":{"N":"1/2"} } },
              {"M": { "name":{"S":"Granulated Onion"}, "unit":{"S":"tsp."}, "amount":{"N":"1/4"} } },
              {"M": { "name":{"S":"Granulated Garlic"}, "unit":{"S":"tsp."}, "amount":{"N":"1/4"} } },
              {"M": { "name":{"S":"Fresh Garlic"}, "unit":{"S":"tsp."}, "amount":{"N":"1/2"} } },
              {"M": { "name":{"S":"Salt"}, "unit":{"S":"tsp."}, "amount":{"N":"1/4"} } },
              {"M": { "name":{"S":"Black Pepper"}, "unit":{"S":"tsp."}, "amount":{"N":"1/4"} } },

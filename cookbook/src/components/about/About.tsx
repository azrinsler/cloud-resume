    ...
    return (
        <div id='about' className='flex-column'>
            ...
            <div className='flex-row hatched-background' style={{paddingTop:'0.5em',borderBottom:'1px solid',flexWrap:'nowrap'}}>
                <div id='about-simple-tab' onClick={()=>{setActiveTab('simple')}} style={activeTab == 'simple' ? {backgroundColor:'light-dark(lightgreen,#962850)',opacity:'85%'} : {opacity:'60%'}}>
                ...
                <div id='about-technical-tab' onClick={()=>{setActiveTab('technical')}} style={activeTab == 'technical' ? {backgroundColor:'light-dark(lightgreen,#962850)',opacity:'85%'} : {opacity:'60%'}}>
                ...
                <div id='resume-tab' onClick={()=>{setActiveTab('resume')}} style={activeTab == 'resume' ? {backgroundColor:'light-dark(lightgreen,#962850)',opacity:'85%'} : {opacity:'60%'}}>
